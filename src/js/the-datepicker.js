...
(function (TheDatepicker) {
  ...
  (function (ClassNameType) {
    ...
    ClassNameType[(ClassNameType['ContainerResponsive'] = 3)] =
      'ContainerResponsive';
    ...
    ClassNameType[(ClassNameType['HeaderNavigation'] = 11)] =
      'HeaderNavigation';
    ...
    ClassNameType[(ClassNameType['HeaderYearsToggle'] = 16)] =
      'HeaderYearsToggle';
    ...
    ClassNameType[(ClassNameType['HeaderTitleContent'] = 23)] =
      'HeaderTitleContent';
    ...
    ClassNameType[(ClassNameType['TableCellUnavailable'] = 32)] =
      'TableCellUnavailable';
    ClassNameType[(ClassNameType['TableCellHighlighted'] = 33)] =
      'TableCellHighlighted';
    ClassNameType[(ClassNameType['TableCellSelected'] = 34)] =
      'TableCellSelected';
    ClassNameType[(ClassNameType['CalendarTable'] = 35)] = 'CalendarTable';
    ClassNameType[(ClassNameType['CalendarTableHeader'] = 36)] =
      'CalendarTableHeader';
    ClassNameType[(ClassNameType['CalendarTableHeaderCell'] = 37)] =
      'CalendarTableHeaderCell';
    ClassNameType[(ClassNameType['CalendarTableBody'] = 38)] =
      'CalendarTableBody';
    ...
    ClassNameType[(ClassNameType['DayButtonContent'] = 51)] =
      'DayButtonContent';
    ClassNameType[(ClassNameType['YearCellButton'] = 52)] = 'YearCellButton';
    ClassNameType[(ClassNameType['YearCellButtonContent'] = 53)] =
      'YearCellButtonContent';
    ClassNameType[(ClassNameType['Animated'] = 54)] = 'Animated';
    ClassNameType[(ClassNameType['AnimateFadeOutLeft'] = 55)] =
      'AnimateFadeOutLeft';
    ClassNameType[(ClassNameType['AnimateFadeInRight'] = 56)] =
      'AnimateFadeInRight';
    ClassNameType[(ClassNameType['AnimateFadeOutUp'] = 57)] =
      'AnimateFadeOutUp';
    ClassNameType[(ClassNameType['AnimateFadeInDown'] = 58)] =
      'AnimateFadeInDown';
    ClassNameType[(ClassNameType['AnimateFadeOutRight'] = 59)] =
      'AnimateFadeOutRight';
    ClassNameType[(ClassNameType['AnimateFadeInLeft'] = 60)] =
      'AnimateFadeInLeft';
    ClassNameType[(ClassNameType['AnimateFadeOutDown'] = 61)] =
      'AnimateFadeOutDown';
    ClassNameType[(ClassNameType['AnimateFadeInUp'] = 62)] = 'AnimateFadeInUp';
    ClassNameType[(ClassNameType['ContainerDarkMode'] = 63)] =
      'ContainerDarkMode';
    ClassNameType[(ClassNameType['MainDarkMode'] = 64)] = 'MainDarkMode';
  })(
    (ClassNameType =
      TheDatepicker.ClassNameType || (TheDatepicker.ClassNameType = {}))
  );
  var ClassNames = (function () {
    ...
    ClassNames.prototype.setClassName = function (type, className) {
      if (type === ClassNameType.ContainerDarkMode) {
        TheDatepicker.Helper_.warnDeprecatedUsage_(
          'ClassNameType.ContainerDarkMode',
          ['ClassNameType.MainDarkMode']
        );
        this.setClassName(ClassNameType.MainDarkMode, className);
      }
      this.classNames_[this.checkType_(type)] =
        this.normalizeClassName_(className);
    };
    ClassNames.prototype.addClassName = function (type, className) {
      this.classNames_[this.checkType_(type)].concat(
        this.normalizeClassName_(className)
      );
    };
    ...
    ClassNames.prototype.checkType_ = function (type) {
      return TheDatepicker.Helper_.checkNumber_(
        'Class name type',
        type,
        0,
        this.classNames_.length - 1
      );
    };
    ClassNames.prototype.normalizeClassName_ = function (className) {
      ...
      if (typeof className !== 'object' || className.constructor !== Array) {
        className = TheDatepicker.Helper_.checkString_(
          parameterName,
          className
        ).split(/\s+/);
      }
      ...
      for (var index = 0; index < className.length; index++) {
        var name_1 = TheDatepicker.Helper_.checkString_(
          parameterName,
          className[index]
        );
        if (name_1) {
...
(function (TheDatepicker) {
  ...
  var DateConverter_ = (function () {
    ...
    DateConverter_.parseDayOfWeekTextual_ = function (text, dateData, options) {
      return DateConverter_.parseDayOfWeekByTranslator_(
        text,
        function (dayOfWeek) {
    ...
    DateConverter_.parseDayOfWeekTextualFull_ = function (
      text,
      dateData,
      options
    ) {
    ...
    DateConverter_.parseMonthTextual_ = function (text, dateData, options) {
      return DateConverter_.parseMonthByTranslator_(
        text,
        dateData,
        function (month) {
    ...
    DateConverter_.parseMonthTextualShort_ = function (
      text,
      dateData,
      options
    ) {
    ...
    DateConverter_.parseMonthByTranslator_ = function (
      text,
      dateData,
      translate
    ) {
    ...
    DateConverter_.parseYear_ = function (text, dateData, options) {
      ...
      var maxPositiveLength =
        maxDate.getFullYear() > 0 ? (maxDate.getFullYear() + '').length : 0;
      var maxNegativeLength =
        minDate.getFullYear() < 0 ? (-minDate.getFullYear() + '').length : 0;
      var yearLength = 0;
...
(function (TheDatepicker) {
  ...
  (function (InitializationPhase) {
    ...
    InitializationPhase[(InitializationPhase['Initialized'] = 3)] =
      'Initialized';
  ...
  var Datepicker = (function () {
    function Datepicker(input, container, options) {
      ...
      container.setAttribute(
        'data-credits',
        'TheDatepicker - Pure JavaScript Datepicker by Slevomat.cz'
      );
      container.setAttribute(
        'data-url',
        ...
        case InitializationPhase.Untouched:
          ...
          if (this.inputClickable_ && this.options.isHiddenOnBlur()) {
            ...
            this.inputListenerRemover_ =
              TheDatepicker.Helper_.addEventListener_(
                this.inputClickable_,
                TheDatepicker.ListenerType_.Focus,
                function (event) {
                  _this.open(event);
                }
              );
    ...
    Datepicker.prototype.selectDate = function (date, doUpdateMonth, event) {
      ...
      return this.viewModel_.selectDay_(
        event,
        TheDatepicker.Helper_.normalizeDate_('Date', date, true, this.options),
        !!doUpdateMonth
      );
    };
    Datepicker.prototype.getSelectedDate = function () {
      return this.viewModel_.selectedDate_
        ? new Date(this.viewModel_.selectedDate_.getTime())
        : null;
    };
    Datepicker.prototype.getSelectedDateFormatted = function (format) {
      ...
      return TheDatepicker.DateConverter_.formatDate_(
        this.viewModel_.selectedDate_,
        this.options,
        TheDatepicker.Helper_.checkString_('Format', format)
      );
    };
    ...
    Datepicker.prototype.goToMonth = function (month, event) {
      ...
      return this.viewModel_.goToMonth_(
        event,
        TheDatepicker.Helper_.normalizeDate_(
          'Month',
          month,
          false,
          this.options
    ...
    Datepicker.prototype.parseRawInput = function () {
      return this.inputText_
        ? TheDatepicker.DateConverter_.parseDate_(
    ...
    Datepicker.prototype.getDay = function (date) {
      return this.viewModel_.createDay_(
        TheDatepicker.Helper_.normalizeDate_('Date', date, false, this.options)
      );
    };
    ...
    Datepicker.prototype.updateInput_ = function () {
      if (
        !this.inputText_ ||
        this.inputText_ === Datepicker.document_.activeElement
      ) {
        return;
      }
      this.inputText_.value =
        TheDatepicker.DateConverter_.formatDate_(
          this.viewModel_.selectedDate_,
          this.options
        ) || '';
      this.updateDeselectElement_();
    ...
    Datepicker.prototype.createContainer_ = function () {
      return TheDatepicker.HtmlHelper_.createDiv_(
        TheDatepicker.ClassNameType.Container,
        this.options
      );
    };
    Datepicker.prototype.createDeselectElement_ = function () {
      ...
      if (
        !this.inputText_ ||
        !this.options.isDeselectButtonShown() ||
        this.deselectElement_
      ) {
        return null;
      }
      var deselectButton = TheDatepicker.HtmlHelper_.createAnchor_(
        function (event) {
          deselectButton.focus();
          _this.viewModel_.cancelSelection_(event);
        },
        this.options,
        TheDatepicker.ClassNameType.DeselectButton
      );
      deselectButton.innerHTML = this.options.getDeselectHtml();
      var title = this.options.translator.translateTitle(
        TheDatepicker.TitleName.Deselect
      );
      if (title !== '') {
        deselectButton.title = title;
      }
      var deselectElement = TheDatepicker.HtmlHelper_.createSpan_();
      TheDatepicker.HtmlHelper_.addClass_(
        deselectElement,
        TheDatepicker.ClassNameType.Deselect,
        this.options
      );
      deselectElement.appendChild(deselectButton);
      this.inputText_.parentNode.insertBefore(
        deselectElement,
        this.inputText_.nextSibling
      );
    ...
    Datepicker.prototype.updateDeselectElement_ = function () {
      ...
      var isVisible =
        this.options.isDeselectButtonShown() && this.viewModel_.selectedDate_;
    ...
    Datepicker.prototype.initListeners_ = function () {
      ...
      if (!Datepicker.areGlobalListenersInitialized_) {
        ...
        TheDatepicker.Helper_.addEventListener_(
          Datepicker.document_,
          TheDatepicker.ListenerType_.MouseDown,
          checkMiss
        );
        TheDatepicker.Helper_.addEventListener_(
          Datepicker.document_,
          TheDatepicker.ListenerType_.FocusIn,
          checkMiss
        );
        TheDatepicker.Helper_.addEventListener_(
          Datepicker.document_,
          TheDatepicker.ListenerType_.KeyDown,
          function (event) {
      ...
      if (this.inputClickable_) {
        ...
        this.listenerRemovers_.push(
          TheDatepicker.Helper_.addEventListener_(
            this.inputClickable_,
            TheDatepicker.ListenerType_.Blur,
            function () {
              _this.updateInput_();
            }
          )
      ...
      if (this.inputText_) {
        this.listenerRemovers_.push(
          TheDatepicker.Helper_.addEventListener_(
            ...
            function (event) {
              ...
              if (
                event.keyCode === TheDatepicker.KeyCode_.Esc &&
                _this.options.isClosedOnEscPress()
              ) {
                _this.close(event);
              }
            }
        ...
        this.listenerRemovers_.push(
          TheDatepicker.Helper_.addEventListener_(
            this.inputText_,
            TheDatepicker.ListenerType_.KeyUp,
            function (event) {
        ...
        this.listenerRemovers_.push(
          TheDatepicker.Helper_.addEventListener_(
            this.inputText_,
            TheDatepicker.ListenerType_.KeyPress,
            function (event) {
    ...
    Datepicker.prototype.triggerReady_ = function (element) {
      for (
        var index = Datepicker.readyListeners_.length - 1;
        index >= 0;
        index--
      ) {
    ...
    Datepicker.prototype.onActivate_ = function () {
      ...
      if (this.inputText_) {
        this.inputText_.readOnly =
          !this.options.isKeyboardOnMobile() &&
          TheDatepicker.Helper_.isMobile_();
      }
    };
    Datepicker.prototype.updateContainer_ = function () {
      ...
      if (this.options.isDarkModeEnabled()) {
        TheDatepicker.HtmlHelper_.addClass_(
          this.container,
          TheDatepicker.ClassNameType.ContainerDarkMode,
          this.options
        );
      }
      if (this.options.isFullScreenOnMobile()) {
        TheDatepicker.HtmlHelper_.addClass_(
          this.container,
          TheDatepicker.ClassNameType.ContainerResponsive,
          this.options
        );
      }
      ...
      var locateOver =
        position === TheDatepicker.Position.TopRight ||
        position === TheDatepicker.Position.TopLeft;
      var locateLeft =
        position === TheDatepicker.Position.BottomLeft ||
        position === TheDatepicker.Position.TopLeft;
      ...
      if (this.options.isPositionFixingEnabled()) {
        ...
        var windowTop =
          window.scrollY ||
          window.pageYOffset ||
          document_1.documentElement.scrollTop ||
          document_1.body.scrollTop ||
          0;
        var windowLeft =
          window.scrollX ||
          window.pageXOffset ||
          document_1.documentElement.scrollLeft ||
          document_1.body.scrollLeft ||
          0;
        var isCompactMode = document_1.compatMode === 'CSS1Compat';
        var windowHeight =
          window.innerHeight ||
          (isCompactMode
            ? document_1.documentElement.clientHeight
            : document_1.body.clientHeight) ||
          0;
        var windowWidth =
          window.innerWidth ||
          (isCompactMode
            ? document_1.documentElement.clientWidth
            : document_1.body.clientWidth) ||
          0;
        ...
        locateOver =
          (locateOver && (fitsTop || !fitsBottom)) || (fitsTop && !fitsBottom);
        locateLeft =
          (locateLeft && (fitsLeft || !fitsRight)) || (fitsLeft && !fitsRight);
      }
      mainElement.style.position = locateOver || locateLeft ? 'absolute' : '';
      if (locateOver) {
        TheDatepicker.HtmlHelper_.addClass_(
          this.container,
          TheDatepicker.ClassNameType.ContainerOver,
          this.options
        );
      ...
      if (locateLeft) {
        TheDatepicker.HtmlHelper_.addClass_(
          this.container,
          TheDatepicker.ClassNameType.ContainerLeft,
          this.options
        );
    ...
    Datepicker.activateViewModel_ = function (event, datepicker) {
      ...
      Datepicker.setBodyClass_(
        !datepicker.isContainerExternal_ &&
          datepicker.options.isFullScreenOnMobile()
      );
...
(function (TheDatepicker) {
  var Day = (function () {
    ...
    Day.prototype.isEqualToDate = function (date) {
      return (
        TheDatepicker.Helper_.isValidDate_(date) &&
        this.dayNumber === date.getDate() &&
        this.month === date.getMonth() + 1 &&
        this.year === date.getFullYear()
      );
    ...
    Day.prototype.getSibling = function (shift) {
      ...
      date.setDate(
        date.getDate() + TheDatepicker.Helper_.checkNumber_('Shift', shift)
      );
...
(function (TheDatepicker) {
  ...
  (function (ListenerType_) {
    ...
    (ListenerType_ =
      TheDatepicker.ListenerType_ || (TheDatepicker.ListenerType_ = {}))
  );
  var Helper_ = (function () {
    ...
    Helper_.normalizeDate_ = function (
      parameterName,
      value,
      isNullable,
      options
      ...
      if (typeof value === 'string') {
        ...
        var matches = value.match(
          new RegExp(
            '^\\s*([0-9]+).?\\s*(' + Helper_.months_.join('|') + ')\\s*',
            'i'
          )
        );
        if (matches) {
        ...
        while (parsedValue) {
          var matches_1 = parsedValue.match(
            /^\s*([+-]?)\s*([0-9]+)\s*(day|week|month|year)s?\s*/i
          );
          if (!matches_1) {
            break;
          }
    ...
    Helper_.addEventListener_ = function (
      element,
      listenerType,
      listener,
      isPassive
    ...
    Helper_.warnDeprecatedUsage_ = function (
      deprecatedMethod,
      alternateMethods
    ) {
      if (!window.console) {
    ...
    Helper_.addSwipeListener_ = function (element, listener) {
      ...
      var minDistance;
      Helper_.addEventListener_(
        element,
        ListenerType_.TouchStart,
        function (event) {
          startPosition = {
      ...
      Helper_.addEventListener_(
        ...
        function (event) {
          ...
          if (Math.abs(diffX) > minDistance.x) {
            moveDirection =
              diffX > 0
                ? TheDatepicker.MoveDirection_.Right
                : TheDatepicker.MoveDirection_.Left;
          } else if (Math.abs(diffY) > minDistance.x) {
            moveDirection =
              diffY > 0
                ? TheDatepicker.MoveDirection_.Down
                : TheDatepicker.MoveDirection_.Up;
          }
          if (moveDirection) {
...
(function (TheDatepicker) {
  var HtmlHelper_ = (function () {
    ...
    HtmlHelper_.createAnchor_ = function (onClick, options, type) {
      if (type === void 0) {
        type = TheDatepicker.ClassNameType.Button;
      }
      ...
      anchor.onkeydown = function (event) {
        event = event || window.event;
        if (
          TheDatepicker.Helper_.inArray_(
            [TheDatepicker.KeyCode_.Enter, TheDatepicker.KeyCode_.Space],
            event.keyCode
          )
        ) {
          TheDatepicker.Helper_.preventDefault_(event);
    ...
    HtmlHelper_.createSelectInput_ = function (
      selectOptions,
      onChange,
      options
    ) {
      var input = document.createElement('select');
      HtmlHelper_.addClass_(
        input,
        TheDatepicker.ClassNameType.SelectInput,
        options
      );
      for (var index = 0; index < selectOptions.length; index++) {
        input.appendChild(
          HtmlHelper_.createSelectOption_(
...
(function (TheDatepicker) {
  ...
  var Options = (function () {
    ...
    Options.prototype.clone = function () {
      ...
      options.dateAvailabilityResolvers_ =
        this.dateAvailabilityResolvers_.slice(0);
      options.cellContentResolver_ = this.cellContentResolver_;
      options.cellContentStructureResolver_ =
        this.cellContentStructureResolver_;
      ...
      options.yearSelectedFromTableOfYears_ =
        this.yearSelectedFromTableOfYears_;
      ...
      options.listeners_.beforeMonthChange =
        this.listeners_.beforeMonthChange.slice(0);
    ...
    Options.prototype.setMinDate = function (date) {
      var normalizedDate = TheDatepicker.Helper_.normalizeDate_(
        'Min date',
        date,
        true,
        this
    ...
    Options.prototype.setInitialMonth = function (month) {
      this.initialMonth_ = TheDatepicker.Helper_.normalizeDate_(
        'Initial month',
        month,
        true,
        this
    ...
    Options.prototype.setInitialDate = function (value) {
      this.initialDate_ = TheDatepicker.Helper_.normalizeDate_(
        'Initial date',
        value,
        true,
        this
    ...
    Options.prototype.setFirstDayOfWeek = function (dayOfWeek) {
      this.firstDayOfWeek_ = TheDatepicker.Helper_.checkNumber_(
        'First day of week',
        dayOfWeek,
        0,
        6
    ...
    Options.prototype.setDateAvailabilityResolver = function (resolver) {
      TheDatepicker.Helper_.warnDeprecatedUsage_(
        'setDateAvailabilityResolver',
        ['addDateAvailabilityResolver']
      );
    ...
    Options.prototype.addDateAvailabilityResolver = function (resolver) {
      this.dateAvailabilityResolvers_.push(
        TheDatepicker.Helper_.checkFunction_('Resolver', resolver, false)
      );
    };
    ...
    Options.prototype.setCellContentResolver = function (resolver) {
      this.cellContentResolver_ = TheDatepicker.Helper_.checkFunction_(
        'Resolver',
        resolver
      );
    };
    Options.prototype.setCellContentStructureResolver = function (
      init,
      update
    ) {
      if (update === void 0) {
      ...
      update = TheDatepicker.Helper_.checkFunction_(
        'Resolver (update)',
        update
      );
    ...
    Options.prototype.setHeaderStructureResolver = function (resolver) {
      this.headerStructureResolver_ = TheDatepicker.Helper_.checkFunction_(
        'Resolver',
        resolver
      );
    };
    Options.prototype.setFooterStructureResolver = function (resolver) {
      this.footerStructureResolver_ = TheDatepicker.Helper_.checkFunction_(
        'Resolver',
        resolver
      );
    };
    Options.prototype.addCellClassesResolver = function (resolver) {
      this.cellClassesResolvers_.push(
        TheDatepicker.Helper_.checkFunction_('Resolver', resolver, false)
      );
    };
    ...
    Options.prototype.addDayModifier = function (modifier) {
      this.dayModifiers_.push(
        TheDatepicker.Helper_.checkFunction_('Modifier', modifier, false)
      );
    };
    ...
    Options.prototype.setInputFormat = function (format) {
      this.inputFormat_ = TheDatepicker.Helper_.checkString_(
        'Input format',
        format,
        true
      );
    ...
    Options.prototype.setTableOfYearsRowsCount = function (count) {
      this.tableOfYearsRowsCount_ = TheDatepicker.Helper_.checkNumber_(
        'Rows count',
        count,
        1
      );
    ...
    Options.prototype.setTableOfYearsAlign = function (align) {
      this.tableOfYearsAlign_ = align
        ? TheDatepicker.Helper_.checkNumber_('Align', align, 1, 3)
        : null;
    };
    ...
    Options.prototype.setAnimateMonthChange = function (value) {
      TheDatepicker.Helper_.warnDeprecatedUsage_('setAnimateMonthChange', [
        'setSlideAnimation',
      ]);
    ...
    Options.prototype.setClassesPrefix = function (prefix) {
      this.classesPrefix_ = TheDatepicker.Helper_.checkString_(
        'Prefix',
        prefix
      );
    };
    ...
    Options.prototype.setDropdownItemsLimit = function (limit) {
      this.dropdownItemsLimit_ = TheDatepicker.Helper_.checkNumber_(
        'Items limit',
        limit,
        1
      );
    ...
    Options.prototype.setPosition = function (position) {
      this.position_ = TheDatepicker.Helper_.checkNumber_(
        'Position',
        position,
        1,
        4
    ...
    Options.prototype.setToday = function (date) {
      this.today_ = TheDatepicker.Helper_.normalizeDate_(
        'Today',
        date,
        true,
        this
    ...
    Options.prototype.onBeforeOpenAndClose = function (listener) {
      TheDatepicker.Helper_.warnDeprecatedUsage_('onBeforeOpenAndClose', [
        'onBeforeOpen',
        'onBeforeClose',
      ]);
    ...
    Options.prototype.offBeforeOpenAndClose = function (listener) {
      ...
      TheDatepicker.Helper_.warnDeprecatedUsage_('offBeforeOpenAndClose', [
        'offBeforeOpen',
        'offBeforeClose',
      ]);
    ...
    Options.prototype.onOpenAndClose = function (listener) {
      TheDatepicker.Helper_.warnDeprecatedUsage_('onOpenAndClose', [
        'onOpen',
        'onClose',
      ]);
    ...
    Options.prototype.offOpenAndClose = function (listener) {
      ...
      TheDatepicker.Helper_.warnDeprecatedUsage_('offOpenAndClose', [
        'offOpen',
        'offClose',
      ]);
    ...
    Options.prototype.getInitialMonth = function () {
      var primarySource = this.initialDatePriority_
        ? this.initialDate_
        : this.initialMonth_;
      var secondarySource = this.initialDatePriority_
        ? this.initialMonth_
        : this.initialDate_;
    ...
    Options.prototype.isMonthAndYearSeparated = function () {
      return (
        this.isYearSelectedFromTableOfYears() || this.monthAndYearSeparated_
      );
    };
    ...
    Options.prototype.isMonthChangeAnimated = function () {
      TheDatepicker.Helper_.warnDeprecatedUsage_('isMonthChangeAnimated', [
    ...
    Options.prototype.getToday = function () {
      return this.today_
        ? new Date(this.today_.getTime())
        : TheDatepicker.Helper_.resetTime_(new Date());
    };
    Options.prototype.getDateAvailabilityResolver = function () {
      ...
      return this.dateAvailabilityResolvers_.length > 0
        ? this.dateAvailabilityResolvers_[0]
        : null;
    };
    ...
    Options.prototype.removeCallback_ = function (
      callbacksList,
      parameterName,
      callback
    ) {
    ...
    Options.prototype.onEvent_ = function (eventType, listener) {
      this.listeners_[eventType].push(
        TheDatepicker.Helper_.checkFunction_('Event listener', listener, false)
      );
    };
    Options.prototype.offEvent_ = function (eventType, listener) {
      listener = TheDatepicker.Helper_.checkFunction_(
        'Event listener',
        listener
      );
      if (!listener) {
        ...
        for (
          var index = 0;
          index < this.listeners_[eventType].length;
          index++
        ) {
...
(function (TheDatepicker) {
  ...
  var Template_ = (function () {
    ...
    Template_.prototype.createSkeleton_ = function (viewModel) {
      var main = TheDatepicker.HtmlHelper_.createDiv_(
        TheDatepicker.ClassNameType.Main,
        this.options_
      );
      TheDatepicker.HtmlHelper_.appendChild_(
        main,
        this.options_.getHeaderStructure_()
      );
      main.appendChild(this.createHeaderElement_(viewModel));
      main.appendChild(this.createBodyElement_(viewModel));
      TheDatepicker.HtmlHelper_.appendChild_(
        main,
        this.options_.getFooterStructure_()
      );
      this.mainElement_ = main;
      return main;
    };
    Template_.prototype.updateMainElement_ = function (viewModel) {
      this.mainElement_.style.display =
        !this.hasInput_ ||
        viewModel.isActive_() ||
        !this.options_.isHiddenOnBlur()
          ? ''
      ...
      if (this.options_.isDarkModeEnabled()) {
        TheDatepicker.HtmlHelper_.addClass_(
          this.mainElement_,
          TheDatepicker.ClassNameType.MainDarkMode,
          this.options_
        );
      }
    };
    Template_.prototype.updateTableElements_ = function (viewModel) {
      this.tableElement_.style.display = viewModel.yearSelectionState_
        ? 'none'
        : '';
      if (this.tableOfYearsElement_) {
        this.tableOfYearsElement_.style.display = viewModel.yearSelectionState_
          ? ''
          : 'none';
      }
    };
    Template_.prototype.createBodyElement_ = function (viewModel) {
      var _this = this;
      var body = TheDatepicker.HtmlHelper_.createDiv_(
        TheDatepicker.ClassNameType.Body,
        this.options_
      );
      var tables = TheDatepicker.HtmlHelper_.createDiv_(
        TheDatepicker.ClassNameType.Tables,
        this.options_
      );
      body.appendChild(tables);
      if (
        this.options_.isMonthChangeOnSwipeEnabled() ||
        this.options_.isTableOfYearsOnSwipeDownEnabled()
      ) {
        TheDatepicker.HtmlHelper_.addClass_(
          body,
          TheDatepicker.ClassNameType.BodySwipeable,
          this.options_
        );
        TheDatepicker.Helper_.addSwipeListener_(
          body,
          function (event, moveDirection) {
            var isForward = false;
            var change = null;
            switch (moveDirection) {
              ...
              case TheDatepicker.MoveDirection_.Up:
                if (
                  _this.tableOfYearsElement_ &&
                  _this.options_.isTableOfYearsOnSwipeDownEnabled() &&
                  viewModel.canSetYearSelectionActive_(isForward)
                ) {
                  change = function () {
              ...
              case TheDatepicker.MoveDirection_.Right:
                if (
                  _this.options_.isMonthChangeOnSwipeEnabled() &&
                  viewModel.canGoDirection_(isForward)
                ) {
                  change = function () {
    ...
    Template_.prototype.createHeaderElement_ = function (viewModel) {
      var header = TheDatepicker.HtmlHelper_.createDiv_(
        TheDatepicker.ClassNameType.Header,
        this.options_
      );
      var top = TheDatepicker.HtmlHelper_.createDiv_(
        TheDatepicker.ClassNameType.HeaderTop,
        this.options_
      );
      header.appendChild(top);
      top.appendChild(this.createTitleElement_(viewModel));
      var control = TheDatepicker.HtmlHelper_.createDiv_(
        TheDatepicker.ClassNameType.HeaderControl,
        this.options_
      );
      top.appendChild(control);
      control.appendChild(this.createResetElement_(viewModel));
      control.appendChild(this.createCloseElement_(viewModel));
      var navigation = TheDatepicker.HtmlHelper_.createDiv_(
        TheDatepicker.ClassNameType.HeaderNavigation,
        this.options_
      );
      header.appendChild(navigation);
      navigation.appendChild(this.createGoElement_(viewModel, false));
      var state = TheDatepicker.HtmlHelper_.createDiv_(
        TheDatepicker.ClassNameType.HeaderState,
        this.options_
      );
    ...
    Template_.prototype.createTitleElement_ = function (viewModel) {
      var titleElement = TheDatepicker.HtmlHelper_.createDiv_(
        TheDatepicker.ClassNameType.HeaderTitle,
        this.options_
      );
      ...
      TheDatepicker.HtmlHelper_.addClass_(
        titleContent,
        TheDatepicker.ClassNameType.HeaderTitleContent,
        this.options_
      );
    ...
    Template_.prototype.createResetElement_ = function (viewModel) {
      var resetElement = TheDatepicker.HtmlHelper_.createDiv_(
        TheDatepicker.ClassNameType.Reset,
        this.options_
      );
      var resetButton = TheDatepicker.HtmlHelper_.createAnchor_(function (
        event
      ) {
    ...
    Template_.prototype.updateResetElement_ = function (viewModel) {
      this.resetElement_.style.display = this.options_.isResetButtonShown()
        ? ''
        : 'none';
    ...
    Template_.prototype.createCloseElement_ = function (viewModel) {
      var closeElement = TheDatepicker.HtmlHelper_.createDiv_(
        TheDatepicker.ClassNameType.Close,
        this.options_
      );
      var closeButton = TheDatepicker.HtmlHelper_.createAnchor_(function (
        event
      ) {
    ...
    Template_.prototype.updateCloseElement_ = function (viewModel) {
      this.closeElement_.style.display =
        this.hasInput_ && this.options_.isCloseButtonShown() ? '' : 'none';
    ...
    Template_.prototype.createGoElement_ = function (viewModel, isForward) {
      var _this = this;
      var goElement = TheDatepicker.HtmlHelper_.createDiv_(
        TheDatepicker.ClassNameType.Go,
        this.options_
      );
      TheDatepicker.HtmlHelper_.addClass_(
        goElement,
        isForward
          ? TheDatepicker.ClassNameType.GoNext
          : TheDatepicker.ClassNameType.GoPrevious,
        this.options_
      );
      var goButton = TheDatepicker.HtmlHelper_.createAnchor_(function (event) {
        var moveDirection = isForward
          ? TheDatepicker.MoveDirection_.Left
          : TheDatepicker.MoveDirection_.Right;
      ...
      goButton.innerHTML = isForward
        ? this.options_.getGoForwardHtml()
        : this.options_.getGoBackHtml();
    ...
    Template_.prototype.updateGoElement_ = function (viewModel, isForward) {
      ...
      goElement.style.visibility = viewModel.canGoDirection_(isForward)
        ? 'visible'
        : 'hidden';
      this.updateTitle_(
        goElement,
        viewModel.yearSelectionState_
          ? isForward
            ? TheDatepicker.TitleName.GoForwardTableOfYears
            : TheDatepicker.TitleName.GoBackTableOfYears
          : isForward
          ? TheDatepicker.TitleName.GoForward
          : TheDatepicker.TitleName.GoBack
      );
    };
    Template_.prototype.createMonthElement_ = function (viewModel) {
      ...
      var selectElement = TheDatepicker.HtmlHelper_.createSelectInput_(
        options,
        function (event, monthNumber) {
      ...
      var monthElement = TheDatepicker.HtmlHelper_.createDiv_(
        TheDatepicker.ClassNameType.HeaderMonth,
        this.options_
      );
    ...
    Template_.prototype.updateMonthElement_ = function (viewModel) {
      ...
      for (var monthNumber = 0; monthNumber < 12; monthNumber++) {
        ...
        var option =
          this.monthSelect_.getElementsByTagName('option')[monthNumber];
      ...
      var showSelect =
        !this.options_.isDropdownWithOneItemHidden() || valuesCount > 1;
    ...
    Template_.prototype.createYearElement_ = function (viewModel) {
      var _this = this;
      var yearElement = TheDatepicker.HtmlHelper_.createDiv_(
        TheDatepicker.ClassNameType.HeaderYear,
        this.options_
      );
      var yearActiveElement;
      if (this.options_.isYearSelectedFromTableOfYears()) {
        yearActiveElement = TheDatepicker.HtmlHelper_.createAnchor_(
          function () {
            _this.slideTable_(
              viewModel,
              viewModel.yearSelectionState_
                ...
                : TheDatepicker.MoveDirection_.Down,
              function () {
                viewModel.setYearSelectionActive_(
                  !viewModel.yearSelectionState_
                );
              }
            );
        ...
        TheDatepicker.HtmlHelper_.addClass_(
          yearActiveElement,
          TheDatepicker.ClassNameType.HeaderYearsToggle,
          this.options_
        );
      } else {
        yearActiveElement = TheDatepicker.HtmlHelper_.createSelectInput_(
          [],
          function (event, year) {
            var currentMonth = viewModel.getCurrentMonth_();
            var newMonth = new Date(currentMonth.getTime());
    ...
    Template_.prototype.updateYearElement_ = function (viewModel) {
      ...
      if (this.tableOfYearsElement_) {
        ...
        var diff = this.calculateDropdownDiff_(
          options,
          range,
          function (value) {
        ...
        for (var index = diff.prepend.length - 1; index >= 0; index--) {
          this.yearActiveElement_.insertBefore(
            TheDatepicker.HtmlHelper_.createSelectOption_(
              diff.prepend[index] + '',
              diff.prepend[index] + ''
            ),
            this.yearActiveElement_.firstChild
          );
        }
        for (var index = 0; index < diff.append.length; index++) {
          this.yearActiveElement_.appendChild(
            TheDatepicker.HtmlHelper_.createSelectOption_(
              diff.append[index] + '',
              diff.append[index] + ''
            )
      ...
      var showSelect =
        !this.options_.isDropdownWithOneItemHidden() || minYear !== maxYear;
    ...
    Template_.prototype.createMonthAndYearElement_ = function (viewModel) {
      var _this = this;
      var monthAndYear = TheDatepicker.HtmlHelper_.createDiv_(
        TheDatepicker.ClassNameType.HeaderMonthYear,
        this.options_
      );
      var selectElement = TheDatepicker.HtmlHelper_.createSelectInput_(
        [],
    ...
    Template_.prototype.updateMonthAndYearElement_ = function (viewModel) {
      ...
      this.monthAndYearElement_.innerText =
        this.translateMonthAndYear_(currentData);
      if (
        !this.options_.isYearAsDropdown() ||
        !this.options_.isMonthAsDropdown()
      ) {
      ...
      var range = this.calculateDropdownRange_(
        currentIndex,
        minIndex,
        maxIndex
      );
      ...
      var diff = this.calculateDropdownDiff_(options, range, function (value) {
        return _this.calculateMonthAndYearIndex_(
          _this.parseMonthAndYearOptionValue_(value)
        );
      });
      for (var index = 0; index < diff.remove.length; index++) {
      ...
      for (var index = diff.prepend.length - 1; index >= 0; index--) {
        ...
        this.monthAndYearSelect_.insertBefore(
          TheDatepicker.HtmlHelper_.createSelectOption_(
            this.getMonthAndYearOptionValue_(data),
            this.translateMonthAndYear_(data)
          ),
          this.monthAndYearSelect_.firstChild
        );
      }
      for (var index = 0; index < diff.append.length; index++) {
        var data = this.getMonthAndYearByIndex_(diff.append[index]);
        this.monthAndYearSelect_.appendChild(
          TheDatepicker.HtmlHelper_.createSelectOption_(
            this.getMonthAndYearOptionValue_(data),
            this.translateMonthAndYear_(data)
          )
      ...
      this.monthAndYearSelect_.value =
        this.getMonthAndYearOptionValue_(currentData);
      var showSelect =
        !this.options_.isDropdownWithOneItemHidden() || range.from < range.to;
    ...
    Template_.prototype.calculateDropdownDiff_ = function (
      options,
      newRange,
      getNumerical
    ) {
      var firstOption =
        options.length > 0 ? getNumerical(options[0].value) : null;
      var lastOption =
        options.length > 0
          ? getNumerical(options[options.length - 1].value)
          : null;
      var prepend = [];
      var append = [];
      var remove = [];
    ...
    Template_.prototype.createTableElement_ = function (viewModel) {
      ...
      var table = TheDatepicker.HtmlHelper_.createTable_(
        tableHeader,
        tableBody,
        TheDatepicker.ClassNameType.CalendarTable,
        this.options_
      );
      TheDatepicker.HtmlHelper_.addClass_(
        table,
        TheDatepicker.ClassNameType.Table,
        this.options_
      );
      return table;
    };
    Template_.prototype.createTableHeaderElement_ = function (viewModel) {
      ...
      return TheDatepicker.HtmlHelper_.createTableHeader_(
        cells,
        TheDatepicker.ClassNameType.CalendarTableHeader,
        this.options_
      );
    };
    Template_.prototype.createTableHeaderCellElement_ = function (
      viewModel,
      dayOfWeek
    ) {
      var headerCell = TheDatepicker.HtmlHelper_.createTableHeaderCell_(
        TheDatepicker.ClassNameType.CalendarTableHeaderCell,
        this.options_
      );
      if (
        ...
        TheDatepicker.HtmlHelper_.addClass_(
          headerCell,
          TheDatepicker.ClassNameType.WeekDayWeekend,
          this.options_
        );
      }
      headerCell.innerText =
        this.options_.translator.translateDayOfWeek(dayOfWeek);
      return headerCell;
    };
    Template_.prototype.createTableBodyElement_ = function (viewModel) {
      ...
      return TheDatepicker.HtmlHelper_.createTableBody_(
        rows,
        TheDatepicker.ClassNameType.CalendarTableBody,
        this.options_
      );
    };
    Template_.prototype.updateWeeksElements_ = function (viewModel) {
      ...
      for (
        var weekIndex = 0;
        weekIndex < this.weeksElements_.length;
        weekIndex++
      ) {
        ...
        if (week) {
          for (
            var dayIndex = 0;
            dayIndex < this.daysElements_[weekIndex].length;
            dayIndex++
          ) {
    ...
    Template_.prototype.updateDayElement_ = function (
      viewModel,
      dayElement,
      dayButtonElement,
      dayContentElement,
      ...
      TheDatepicker.HtmlHelper_.addClass_(
        dayElement,
        TheDatepicker.ClassNameType.TableCell,
        this.options_
      );
      ...
      TheDatepicker.HtmlHelper_.addClass_(
        dayElement,
        TheDatepicker.ClassNameType.Day,
        this.options_
      );
      if (day.isToday) {
        TheDatepicker.HtmlHelper_.addClass_(
          dayElement,
          TheDatepicker.ClassNameType.DayToday,
          this.options_
        );
      }
      if (day.isPast) {
        TheDatepicker.HtmlHelper_.addClass_(
          dayElement,
          TheDatepicker.ClassNameType.DayPast,
          this.options_
        );
      }
      if (day.isWeekend) {
        TheDatepicker.HtmlHelper_.addClass_(
          dayElement,
          TheDatepicker.ClassNameType.DayWeekend,
          this.options_
        );
      }
      if (!day.isAvailable) {
        TheDatepicker.HtmlHelper_.addClass_(
          dayElement,
          TheDatepicker.ClassNameType.TableCellUnavailable,
          this.options_
        );
        TheDatepicker.HtmlHelper_.addClass_(
          dayElement,
          TheDatepicker.ClassNameType.DayUnavailable,
          this.options_
        );
      }
      if (!day.isInCurrentMonth) {
        TheDatepicker.HtmlHelper_.addClass_(
          dayElement,
          TheDatepicker.ClassNameType.DayOutside,
          this.options_
        );
      }
      if (day.isHighlighted) {
        TheDatepicker.HtmlHelper_.addClass_(
          dayElement,
          TheDatepicker.ClassNameType.TableCellHighlighted,
          this.options_
        );
        TheDatepicker.HtmlHelper_.addClass_(
          dayElement,
          TheDatepicker.ClassNameType.DayHighlighted,
          this.options_
        );
      }
      if (day.isSelected) {
        TheDatepicker.HtmlHelper_.addClass_(
          dayElement,
          TheDatepicker.ClassNameType.TableCellSelected,
          this.options_
        );
        TheDatepicker.HtmlHelper_.addClass_(
          dayElement,
          TheDatepicker.ClassNameType.DaySelected,
          this.options_
        );
      }
    ...
    Template_.prototype.createTableCellButtonElement_ = function (viewModel) {
      var _this = this;
      var cellButton = TheDatepicker.HtmlHelper_.createAnchor_(function (
        event
      ) {
        var previous = viewModel.selectedDate_;
        var isSelected = viewModel.selectDay_(
          event,
          cellButton.day,
          false,
          true,
        ...
        if (
          _this.options_.isHiddenOnSelect() &&
          (isSelected || (previous && cellButton.day.isEqualToDate(previous)))
        ) {
          viewModel.close_(event);
        }
      },
      ...
      TheDatepicker.HtmlHelper_.addClass_(
        cellButton,
        TheDatepicker.ClassNameType.DayButton,
        this.options_
      );
      ...
      cellButton.onmouseenter = function (event) {
        if (
          _this.options_.getBeforeFocusListeners().length > 0 ||
          _this.options_.getFocusListeners().length > 0
        ) {
          viewModel.highlightDay_(
            event || window.event,
            cellButton.day,
            false,
            false
    ...
    Template_.prototype.createTableCellContentElement_ = function (viewModel) {
      ...
      TheDatepicker.HtmlHelper_.addClass_(
        cellContent,
        TheDatepicker.ClassNameType.ButtonContent,
        this.options_
      );
      TheDatepicker.HtmlHelper_.addClass_(
        cellContent,
        TheDatepicker.ClassNameType.DayButtonContent,
        this.options_
      );
      return cellContent;
    };
    Template_.prototype.createTableOfYearsElement_ = function (viewModel) {
      ...
      var table = TheDatepicker.HtmlHelper_.createTable_(
        null,
        tableBody,
        TheDatepicker.ClassNameType.YearsTable,
        this.options_
      );
      TheDatepicker.HtmlHelper_.addClass_(
        table,
    ...
    Template_.prototype.createTableOfYearsBodyElement_ = function (viewModel) {
      ...
      for (
        var index = 0;
        index < this.options_.getTableOfYearsRowsCount();
        index++
      ) {
      ...
      return TheDatepicker.HtmlHelper_.createTableBody_(
        rows,
        TheDatepicker.ClassNameType.YearsTableBody,
        this.options_
      );
    };
    Template_.prototype.updateTableOfYearsRowsElements_ = function (viewModel) {
      ...
      for (
        var rowIndex = 0;
        rowIndex < this.yearsElements_.length;
        rowIndex++
      ) {
        ...
        if (cells) {
          for (
            var columnIndex = 0;
            columnIndex < this.yearsElements_[rowIndex].length;
            columnIndex++
          ) {
    ...
    Template_.prototype.updateTableOfYearsCellElement_ = function (
      viewModel,
      yearElement,
      yearButtonElement,
      yearContentElement,
    ...
    Template_.prototype.createTableOfYearsRowElement_ = function (viewModel) {
      ...
      for (
        var index = 0;
        index < this.options_.getTableOfYearsColumnsCount();
        index++
      ) {
        var cell = TheDatepicker.HtmlHelper_.createTableCell_();
    ...
    Template_.prototype.createTableOfYearsCellButtonElement_ = function (
      viewModel
    ) {
      var _this = this;
      var cellButton = TheDatepicker.HtmlHelper_.createAnchor_(function (
        ...
        var newMonth = new Date(
          cellButton.yearCellData.yearNumber,
          viewModel.getCurrentMonth_().getMonth(),
          1
        );
      ...
      TheDatepicker.HtmlHelper_.addClass_(
        cellButton,
        TheDatepicker.ClassNameType.YearCellButton,
        this.options_
      );
    ...
    Template_.prototype.createTableOfYearsCellContentElement_ = function (
      viewModel
    ) {
      ...
      TheDatepicker.HtmlHelper_.addClass_(
        cellContent,
        TheDatepicker.ClassNameType.YearCellButtonContent,
        this.options_
      );
      return cellContent;
    };
    Template_.prototype.slideTable_ = function (
      viewModel,
      moveDirection,
      onComplete
    ) {
      var _this = this;
      if (
        !this.options_.isSlideAnimationEnabled() ||
        !TheDatepicker.Helper_.isCssAnimationSupported_()
      ) {
        onComplete();
        return;
      }
      var trigger = function () {
        ...
        var animate = function (type) {
          TheDatepicker.HtmlHelper_.addClass_(
            _this.tablesElement_,
            TheDatepicker.ClassNameType.Animated,
            _this.options_
          );
          TheDatepicker.HtmlHelper_.addClass_(
            _this.tablesElement_,
        ...
        listenerRemover = TheDatepicker.Helper_.addEventListener_(
          _this.tablesElement_,
          TheDatepicker.ListenerType_.AnimationEnd,
          function () {
...
(function (TheDatepicker) {
  ...
  (function (TitleName) {
    ...
    TitleName[(TitleName['GoForwardTableOfYears'] = 8)] =
  ...
  var Translator = (function () {
    function Translator() {
      ...
      this.dayOfWeekTranslations_ = ['Su', 'Mo', 'Tu', 'We', 'Th', 'Fr', 'Sa'];
    ...
    Translator.prototype.clone = function () {
      ...
      for (index = 0; index < this.dayOfWeekFullTranslations_.length; index++) {
        translator.dayOfWeekFullTranslations_ =
          this.dayOfWeekFullTranslations_.slice(0);
      }
      for (index = 0; index < this.dayOfWeekTranslations_.length; index++) {
        translator.dayOfWeekTranslations_ =
          this.dayOfWeekTranslations_.slice(0);
      }
      ...
      for (index = 0; index < this.monthShortTranslations_.length; index++) {
        translator.monthShortTranslations_ =
          this.monthShortTranslations_.slice(0);
      }
    ...
    Translator.prototype.setDayOfWeekTranslation = function (
      dayOfWeek,
      translation
    ) {
      this.dayOfWeekTranslations_[
        TheDatepicker.Helper_.checkNumber_('Day of week', dayOfWeek, 0, 6)
      ] = TheDatepicker.Helper_.checkString_('Translation', translation, true);
    };
    Translator.prototype.setDayOfWeekFullTranslation = function (
      dayOfWeek,
      translation
    ) {
      this.dayOfWeekFullTranslations_[
    ...
    Translator.prototype.setMonthTranslation = function (month, translation) {
      this.monthTranslations_[
        TheDatepicker.Helper_.checkNumber_('Month', month, 0, 11)
      ] = TheDatepicker.Helper_.checkString_('Translation', translation, true);
    };
    Translator.prototype.setMonthShortTranslation = function (
      month,
      translation
    ) {
      this.monthShortTranslations_[
    ...
    Translator.prototype.setTitleTranslation = function (
      titleName,
      translation
    ) {
      this.titles_[
        TheDatepicker.Helper_.checkNumber_(
          'Title',
          titleName,
          0,
          this.titles_.length - 1
        )
      ] = TheDatepicker.Helper_.checkString_('Translation', translation);
    };
...
(function (TheDatepicker) {
  ...
  (function (MoveDirection_) {
    ...
    (MoveDirection_ =
      TheDatepicker.MoveDirection_ || (TheDatepicker.MoveDirection_ = {}))
  );
  var YearSelectionState = (function () {
    ...
    YearSelectionState.prototype.getLastYear = function () {
      return (
        this.lowestYear + this.page * this.cellsCount + this.cellsCount - 1
      );
    };
  ...
  var ViewModel_ = (function () {
    function ViewModel_(options_, datepicker_) {
      ...
      this.active_ = false;
      this.template_ = new TheDatepicker.Template_(
        this.options_,
        datepicker_.container,
        !!datepicker_.input
      );
    }
    ...
    ViewModel_.prototype.setActive_ = function (event, value) {
      ...
      this.active_ = value;
      if (
        ((!value && !this.setYearSelectionActive_(false)) || value) &&
        this.options_.isHiddenOnBlur()
      ) {
        this.render_();
      }
    ...
    ViewModel_.prototype.goToMonth_ = function (
      event,
      month,
      doCancelHighlight
    ) {
      ...
      month.setDate(1);
      if (
        month.getTime() === this.getCurrentMonth_().getTime() ||
        !this.canGoToMonth_(month)
      ) {
        return false;
      }
    ...
    ViewModel_.prototype.selectDay_ = function (
      event,
      date,
      doUpdateMonth,
      doHighlight,
      ...
      var previousDay = this.selectedDate_
        ? this.createDay_(this.selectedDate_)
        : null;
    ...
    ViewModel_.prototype.canSetYearSelectionActive_ = function (value) {
      return (
        ...
        (!value ||
          this.options_.getMinDate_().getFullYear() !==
            this.options_.getMaxDate_().getFullYear())
      );
    };
    ...
    ViewModel_.prototype.selectNearestDate_ = function (event, date) {
      return this.selectDay_(
        event,
        this.options_.findNearestAvailableDate(date)
      );
    };
    ViewModel_.prototype.selectPossibleDate_ = function () {
      try {
        return this.selectDay_(
          null,
          this.options_.findPossibleAvailableDate(this.selectedDate_),
          false
        );
      } catch (error) {
    ...
    ViewModel_.prototype.highlightDay_ = function (
      event,
      day,
      doUpdateMonth,
      doFocus
    ...
    ViewModel_.prototype.highlightSiblingDay_ = function (
      event,
      day,
      direction
    ) {
    ...
    ViewModel_.prototype.highlightYear_ = function (year, doFocus) {
      ...
      if (
        this.yearSelectionState_ &&
        this.yearSelectionState_.highlightYear(year, doFocus)
      ) {
        this.render_();
        return true;
      }
    ...
    ViewModel_.prototype.cancelYearHighlight_ = function () {
      if (
        this.yearSelectionState_ &&
        this.yearSelectionState_.cancelHighlight()
      ) {
        this.render_();
        return true;
      }
    ...
    ViewModel_.prototype.getYearsRows_ = function () {
      ...
      for (
        var year = firstYear;
        year <= firstYear + this.yearSelectionState_.cellsCount;
        year++
      ) {
      ...
      for (
        var i = 0;
        i < yearsData.length;
        i += this.tableOfYearsSettings_.columnsCount
      ) {
        yearsRows.push(
          yearsData.slice(i, i + this.tableOfYearsSettings_.columnsCount)
        );
      }
    ...
    ViewModel_.prototype.createYearSelectionState_ = function () {
      ...
      if (
        (align === TheDatepicker.Align.Left && minDate === null) ||
      ...
      if (!align) {
        if (minDate && maxDate) {
          ...
          align =
            lowDiff > highDiff
              ? TheDatepicker.Align.Right
              : TheDatepicker.Align.Left;
        } else if (minDate) {
      ...
      var lowestYear;
      var cellsCount =
        this.tableOfYearsSettings_.rowsCount *
        this.tableOfYearsSettings_.columnsCount;
      var minYear = this.options_.getMinDate_().getFullYear();
      var maxYear = this.options_.getMaxDate_().getFullYear();
      switch (align) {
        ...
        case TheDatepicker.Align.Right:
          lowestYear =
            minYear - (cellsCount - ((maxYear - minYear) % cellsCount) - 1);
          break;
        case TheDatepicker.Align.Center:
          var shift =
            Math.floor(this.tableOfYearsSettings_.rowsCount / 2) *
              this.tableOfYearsSettings_.columnsCount +
            Math.floor(this.tableOfYearsSettings_.columnsCount / 2);
          lowestYear =
            minYear -
            (cellsCount - ((initialYear + shift - minYear) % cellsCount) - 1);
          break;
        default:
    ...
    ViewModel_.prototype.triggerKeyPress_ = function (event) {
      if (
        TheDatepicker.Helper_.inArray_(
          [
            TheDatepicker.KeyCode_.Left,
            TheDatepicker.KeyCode_.Up,
            TheDatepicker.KeyCode_.Right,
            TheDatepicker.KeyCode_.Down,
          ],
          event.keyCode
        )
      ) {
        TheDatepicker.Helper_.preventDefault_(event);
        var moveDirection = this.translateKeyCodeToMoveDirection_(
          event.keyCode
        );
        if (this.yearSelectionState_) {
          if (this.yearSelectionState_.highlightedYear) {
            this.highlightSiblingYear_(
              this.yearSelectionState_.highlightedYear,
              moveDirection
            );
          } else if (
            this.yearSelectionState_.getPage() ===
            this.yearSelectionState_.initialPage
          ) {
            this.highlightSiblingYear_(
              this.getCurrentMonth_().getFullYear(),
              moveDirection
            );
          } else {
            this.highlightYear_(
              this.yearSelectionState_.getPage() === 0
                ? this.yearSelectionState_.lowestYear
                : this.yearSelectionState_.getFirstYear()
            );
          }
        } else {
          if (this.highlightedDay_) {
            this.highlightSiblingDay_(
              event,
              this.highlightedDay_,
              moveDirection
            );
          } else if (
            this.selectedDate_ &&
            this.selectedDate_.getFullYear() ===
              this.getCurrentMonth_().getFullYear() &&
        ...
        event.keyCode === TheDatepicker.KeyCode_.Esc &&
        this.options_.isClosedOnEscPress()
      ) {
        if (this.yearSelectionState_) {
    ...
    ViewModel_.prototype.triggerOnBeforeSelect_ = function (
      event,
      day,
      previousDay
    ) {
      var _this = this;
      return this.options_.triggerEvent_(
        TheDatepicker.EventType_.BeforeSelect,
        function (listener) {
    ...
    ViewModel_.prototype.triggerOnSelect_ = function (event, day, previousDay) {
      var _this = this;
      this.options_.triggerEvent_(
        TheDatepicker.EventType_.Select,
        function (listener) {
          return listener.call(_this.datepicker_, event, day, previousDay);
        }
      );
    ...
    ViewModel_.prototype.triggerOnBeforeOpen_ = function (event) {
      var _this = this;
      return this.options_.triggerEvent_(
        TheDatepicker.EventType_.BeforeOpen,
        function (listener) {
    ...
    ViewModel_.prototype.triggerOnBeforeClose_ = function (event) {
      var _this = this;
      return this.options_.triggerEvent_(
        TheDatepicker.EventType_.BeforeClose,
        function (listener) {
    ...
    ViewModel_.prototype.triggerOnClose_ = function (event) {
      var _this = this;
      this.options_.triggerEvent_(
        TheDatepicker.EventType_.Close,
        function (listener) {
          return listener.call(_this.datepicker_, event, false);
        }
      );
    };
    ViewModel_.prototype.triggerOnBeforeMonthChange_ = function (
      event,
      month,
      previousMonth
    ) {
      var _this = this;
      return this.options_.triggerEvent_(
        TheDatepicker.EventType_.BeforeMonthChange,
        function (listener) {
          return listener.call(_this.datepicker_, event, month, previousMonth);
        }
      );
    };
    ViewModel_.prototype.triggerOnMonthChange_ = function (
      event,
      month,
      previousMonth
    ) {
      var _this = this;
      this.options_.triggerEvent_(
        TheDatepicker.EventType_.MonthChange,
        function (listener) {
          return listener.call(_this.datepicker_, event, month, previousMonth);
        }
      );
    };
    ViewModel_.prototype.triggerOnBeforeFocus_ = function (
      event,
      day,
      previousDay
    ) {
      var _this = this;
      return this.options_.triggerEvent_(
        TheDatepicker.EventType_.BeforeFocus,
        function (listener) {
          return listener.call(_this.datepicker_, event, day, previousDay);
        }
      );
    ...
    ViewModel_.prototype.triggerOnFocus_ = function (event, day, previousDay) {
      var _this = this;
      this.options_.triggerEvent_(
        TheDatepicker.EventType_.Focus,
        function (listener) {
          return listener.call(_this.datepicker_, event, day, previousDay);
        }
      );
    ...
    ViewModel_.prototype.getOutsideDates_ = function () {
      ...
      var prependDaysCount =
        (firstDateOfMonth.getDay() - firstDayOfWeek + 7) % 7;
      var prepend = [];
      for (
        var date = lastMonthDaysCount - prependDaysCount + 1;
      ...
      var appendDaysCount =
        6 - ((lastDateOfMonth.getDay() - firstDayOfWeek + 7) % 7);
      var append = [];
      ...
      if (this.options_.hasFixedRowsCount()) {
        var monthDaysCount = lastDateOfMonth.getDate();
        for (
          var date = appendDaysCount + 1;
          prependDaysCount + monthDaysCount + append.length < 6 * 7;
          date++
        ) {
          append.push(
            new Date(
